...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT / "my_data/mydata_yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "my_data/mydata.yaml", help="dataset.yaml path")

    # 👇 这里我已经帮你改成了和你截图一模一样的名字 (my_hyp.scratch.yaml) 👇
